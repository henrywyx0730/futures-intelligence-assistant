...
class ChineseDeterministicAnalysisCorpusTests(unittest.TestCase):
    ...
    def test_fixture_loads_with_g1_schema_and_no_active_enforcement(self) -> None:
        """Keep future behavior descriptive until its named phase is implemented."""
        self.assertTrue(FIXTURE_PATH.is_file())
        self.assertEqual(self.corpus.schema_version, 1)
        self.assertEqual(self.corpus.active_enforcement_phases, ())
